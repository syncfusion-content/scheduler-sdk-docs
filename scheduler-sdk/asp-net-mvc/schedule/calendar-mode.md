---
layout: post
title: Calendar Mode in ASP.NET MVC Scheduler | Syncfusion
...
# Calendar Mode in ASP.NET MVC Scheduler
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/schedule/islamic-calendar/calendar/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Data.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/schedule/islamic-calendar/calendar/data.cs %}
{% endhighlight %}
...
N> Recurrence options are not currently supported in Islamic calendar mode.
