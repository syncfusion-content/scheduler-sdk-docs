---
layout: post
title: Strict Mode in ASP.NET MVC Datetimepicker Component
description: Learn here all about Strict Mode in Syncfusion ASP.NET MVC Datetimepicker component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Strictmode.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode/strictmode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Strictmode.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode/strictmode.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode-disabled/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Strictmode.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode-disabled/strictmode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode-disabled/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Strictmode.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/strict-mode-disabled/strictmode.cs %}
{% endhighlight %}
