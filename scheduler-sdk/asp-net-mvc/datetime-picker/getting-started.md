...
description: Checkout and learn about getting started with ASP.NET MVC Datetimepicker control of Syncfusion Essential JS 2 and more details.
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC DateTimePicker control in `~/Views/Home/Index.cshtml` page.

{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/getting-started/getting-started/razor %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/datetime-picker/getting-started/daterange/razor %}
{% endhighlight %}
{% endtabs %}
