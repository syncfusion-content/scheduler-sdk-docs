---
layout: post
title: Accessibility in ASP.NET MVC Daterangepicker Component | Syncfusion
description: Learn here all about accessibility in Syncfusion ASP.NET MVC Daterangepicker component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/accessibility/tagHelper %}
{% endhighlight %}
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/accessibility/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Accessibility.cs" %}
{% endhighlight %}
{% endtabs %}
