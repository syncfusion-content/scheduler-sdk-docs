---
layout: post
title: Getting Started with ASP.NET MVC Daterangepicker | Syncfusion
description: Checkout and learn about getting started with ASP.NET MVC Daterangepicker control of Syncfusion Essential JS 2 and more details.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/getting-started/getting-started/razor %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/getting-started/daterange/razor %}
{% endhighlight %}
{% endtabs %}
