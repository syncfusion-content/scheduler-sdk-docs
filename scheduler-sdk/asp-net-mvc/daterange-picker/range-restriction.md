---
layout: post
title: Range Restriction in ASP.NET MVC Daterangepicker Component
description: Learn here all about Range Restriction in Syncfusion ASP.NET MVC Daterangepicker component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/daterange/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Daterange.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/daterange/daterange.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/daterange/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Daterange.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/daterange/daterange.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/rangespan/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/rangespan/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Rangespan.cs" %}
{% endhighlight %}{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/strictmode/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Strickmode.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/strictmode/strickmode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/strictmode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Strickmode.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/daterange-picker/range-restriction/strictmode/strickmode.cs %}
{% endhighlight %}
