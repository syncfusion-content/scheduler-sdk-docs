---
layout: post
title: Change The First Day Of Week in ASP.NET MVC Calendar Control | Syncfusion
description: Learn here all about how to change the first day of week in Syncfusion ASP.NET MVC Calendar control of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/calendar/howto/firstday/tagHelper %}
{% endhighlight %}
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/calendar/howto/firstday/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Firstday.cs" %}
{% endhighlight %}{% endtabs %}
{% endif %}
