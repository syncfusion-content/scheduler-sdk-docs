...
This section briefly explains how to include the [ASP.NET MVC TimePicker](https://www.syncfusion.com/aspnet-mvc-ui-controls/timepicker) control in an ASP.NET MVC application using Visual Studio.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/time-picker/getting-started/getting-started/razor %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/time-picker/getting-started/daterange/razor %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/time-picker/getting-started/format/razor %}
{% endhighlight %}
{% endtabs %}
