---
layout: post
title: Strict Mode in ASP.NET MVC Datepicker Component
description: Learn here all about Strict Mode in Syncfusion ASP.NET MVC Datepicker component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-true/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Strict-true.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-true/strict-true.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-true/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Strict-true.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-true/strict-true.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-false/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Strict-false.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-false/strict-false.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-false/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Strict-false.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/strict-mode/strict-false/strict-false.cs %}
{% endhighlight %}
