---
layout: post
title: Date Range in ASP.NET MVC Datepicker Component
description: Learn here all about Date Range in Syncfusion ASP.NET MVC Datepicker component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/daterange/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Daterange.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/daterange/daterange.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/daterange/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Daterange.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-mvc/date-picker/daterange/daterange.cs %}
{% endhighlight %}
