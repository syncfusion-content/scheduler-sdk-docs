...
This guide uses the [Angular TimePicker component](https://www.syncfusion.com/angular-components/angular-timepicker) for demonstration. Add the Angular TimePicker component component with:
...
- Import the TimePicker component component in your application.
...
{% include code-snippet/scheduler-sdk/angular/time-picker/getting-started-cs2/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/time-picker/getting-started-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/time-picker/getting-started-cs2" %}
...
{% tabs %}
{% highlight ts tabtitle="app.ts" %}
{% include code-snippet/scheduler-sdk/angular/time-picker/getting-started-cs3/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/time-picker/getting-started-cs3/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/time-picker/getting-started-cs3" %}
...
{% tabs %}
{% highlight ts tabtitle="app.ts" %}
{% include code-snippet/scheduler-sdk/angular/time-picker/getting-started-cs4/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/time-picker/getting-started-cs4/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/time-picker/getting-started-cs4" %}
