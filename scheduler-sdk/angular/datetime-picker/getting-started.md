...
This guide uses the [Angular DateTimePicker component](https://www.syncfusion.com/angular-components/angular-datetime-picker) for demonstration. Add the Angular DateTimePicker component component with:
...
- Import the DateTimePicker component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the DateTimePicker component:
...
{% include code-snippet/scheduler-sdk/angular/datetime-picker/accessibility-cs4/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/datetime-picker/accessibility-cs4/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/datetime-picker/accessibility-cs4" %}
...
{% tabs %}
{% highlight ts tabtitle="app.ts" %}
{% include code-snippet/scheduler-sdk/angular/datetime-picker/accessibility-cs5/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/datetime-picker/accessibility-cs5/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/datetime-picker/accessibility-cs5" %}
