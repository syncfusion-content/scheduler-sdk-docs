...
description: Learn how to set up an Angular application with Electron and integrate the Syncfusion Angular Scheduler using a standalone component approach.
