...
The following sample demonstrates how to set the Scheduler component's state persistence.
...
{% previewsample "https://helpstaging.syncfusion.com/samples/scheduler-sdk/angular/schedule/default-cs62" %}
