...
This guide uses the [Angular DateRangePicker component](https://www.syncfusion.com/angular-components/angular-daterangepicker) for demonstration. Add the Angular DateRangePicker component component with:
...
- Import the DateRangePicker component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the DateRangePicker component:
...
{% include code-snippet/scheduler-sdk/angular/daterange-picker/getting-started-cs5/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/daterange-picker/getting-started-cs5/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/daterange-picker/getting-started-cs5" %}
...
{% tabs %}
{% highlight ts tabtitle="app.ts" %}
{% include code-snippet/scheduler-sdk/angular/daterange-picker/getting-started-cs6/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/scheduler-sdk/angular/daterange-picker/getting-started-cs6/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/scheduler-sdk/angular/daterange-picker/getting-started-cs6" %}
