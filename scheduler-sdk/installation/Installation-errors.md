...
**Error Message:** Sorry, the provided unlock key is a trial unlock key and cannot be used to unlock the licensed version of our Essential Studio for Scheduler SDK installer.
...
**Error Message:** Your license for Syncfusion Essential Studio for Scheduler SDK has been expired since {date}. Please renew your subscription and try again.
...
**Error Message:** Sorry, we are unable to find a valid license or trial for Essential Studio for Scheduler SDK under your account.
