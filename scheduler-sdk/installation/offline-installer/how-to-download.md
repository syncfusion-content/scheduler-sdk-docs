---
layout: post
title: Downloading Syncfusion Scheduler SDK Offline Installer - Syncfusion
description: Learn here about how to download the Syncfusion Scheduler SDK offline installer from our Syncfusion website with license.
...
# Downloading Syncfusion Scheduler SDK Offline Installer

The Syncfusion offline installer can be downloaded from the [Syncfusion](https://www.syncfusion.com/) website. You can either download the licensed installer or try our trial installer depending on your license type.
...
6. Click the **More Download Options** button (shown in the screenshot above) to get the Scheduler SDK Offline trial installer, which is available in EXE and ZIP format. The **EXE** is the standard Windows installer; the **ZIP** package is intended for manual or scripted deployments.
...
4. To download an older version installer, go to the [Downloads Older Versions](https://www.syncfusion.com/account/downloads/studio) page (highlighted in the screenshot below).
5. To download other platform/add-on installers, go to **More Download Options** (highlighted in the screenshot below).

   ![License and downloads of Syncfusion Scheduler SDK](images/license-download.png)

6. For Windows OS, the EXE and ZIP formats are available for download. Both are offline installers (e.g., `Syncfusion_Scheduler_SDK_<version>.exe` or `Syncfusion_Scheduler_SDK_<version>.zip`). The EXE is supported on Windows 10/11 and Windows Server 2016 or later.

   ![License and downloads of Syncfusion Scheduler SDK](images/start-trial-download-offline-installer.png)

You can also refer to the [**Offline installer**](https://help.syncfusion.com/scheduler-sdk/installation/offline-installer/how-to-install) link for step-by-step installation guidelines.	