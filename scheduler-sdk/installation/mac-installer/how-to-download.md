...
# Downloading Syncfusion Scheduler SDK Mac Installer
...
1. You can evaluate our 30-day free trial by visiting the [Download Free Trial](https://www.syncfusion.com/downloads) page, selecting the product, and choosing the **Mac** platform.
...
4. Unlock key is not required to install the Syncfusion Scheduler SDK Mac trial installer.
5. Before the trial expires, you can download the trial installer at any time from your registered account's [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page (as shown in below screenshot.)

   ![Trial and downloads of Syncfusion Scheduler SDK](images/trial-download.png)

6. Click the **More Download Options** button (shown in the screenshot above) to get the Scheduler SDK Mac trial installer, which is available in PKG format.
...
3. From the list, select the **Scheduler SDK** product and go to **More Download Options** (shown in the screenshot below) to access the Mac installer.
...
You can also refer to the [**Scheduler SDK Mac Installer**](https://help.syncfusion.com/scheduler-sdk/installation/mac-installer/how-to-install) link for step-by-step installation guidelines.	
