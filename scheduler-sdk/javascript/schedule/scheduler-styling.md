...
Override the Scheduler's default CSS to customize its appearance, or create a custom theme with [`Theme Studio`](`https://ej2.syncfusion.com/themestudio/?theme=material`). Below are commonly used CSS classes.
