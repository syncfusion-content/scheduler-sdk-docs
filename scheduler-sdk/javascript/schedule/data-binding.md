---
layout: post
title: Data Binding in JavaScript Scheduler | Syncfusion
description: Learn how to bind data to the Syncfusion JavaScript Scheduler from local JavaScript arrays and remote REST services using DataManager.
