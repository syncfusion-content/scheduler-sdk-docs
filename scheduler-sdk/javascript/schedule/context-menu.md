---
layout: post
title: Context menu in JavaScript Scheduler control | Syncfusion
description: To implement and customize the context menu in the Syncfusion JavaScript Scheduler control for Essential JS 2, with cell and appointment actions.
...
{% include code-snippet/scheduler-sdk/javascript/schedule/context-menu-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/javascript/schedule/context-menu-cs1/index.html %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/scheduler-sdk/javascript/schedule/context-menu-cs1/datasource.ts %}
{% endhighlight %}
{% endtabs %}
