---
layout: post
title: Islamic calendar in JavaScript Calendar control | Syncfusion
description: Learn here all about Islamic calendar in Syncfusion JavaScript Calendar control of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/javascript/calendar/islamic-calendar-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/javascript/calendar/islamic-calendar-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/scheduler-sdk/javascript/calendar/islamic-calendar-cs1" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/scheduler-sdk/javascript/calendar/islamic-calendar-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/javascript/calendar/islamic-calendar-cs1/index.html %}
{% endhighlight %}
