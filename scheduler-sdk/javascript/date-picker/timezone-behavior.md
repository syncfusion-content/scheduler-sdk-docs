---
layout: post
title: Timezone Behavior in JavaScript Datepicker | Syncfusion
description: Learn here all about Timezone Behavior in Syncfusion JavaScript Datepicker control of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/scheduler-sdk/javascript/date-picker/timezone-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/javascript/date-picker/timezone-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/scheduler-sdk/javascript/date-picker/timezone-cs1" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/scheduler-sdk/javascript/date-picker/timezone-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/javascript/date-picker/timezone-cs1/index.html %}
{% endhighlight %}
