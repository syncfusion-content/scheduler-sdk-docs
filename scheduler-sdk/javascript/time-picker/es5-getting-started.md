...
description:  Checkout and learn about Es5 getting started with JavaScript Timepicker control of Syncfusion Essential JS 2 and more details.
...
# Getting started in JavaScript Timepicker control
...
{% include code-snippet/scheduler-sdk/javascript/time-picker/getting-started-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/javascript/time-picker/getting-started-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/scheduler-sdk/javascript/time-picker/getting-started-cs1" %}
