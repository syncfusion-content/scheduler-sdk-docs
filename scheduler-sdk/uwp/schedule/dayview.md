...
{% endhighlight %}
{% endtabs %}
![ViewHeader Appearance in UWP Scheduler](daymodule_images/viewheader_day.png)
...
{% endhighlight %}
{% endtabs %}
![TimeInterval Changing in UWP Scheduler](daymodule_images/timeinterval_day.png)
...
{% endhighlight %}
{% endtabs %}
![TimeInterval Customization in UWP Scheduler](daymodule_images/customtimeinterval_day.png)
...
{% endhighlight %}
{% endtabs %}
![Changing Working hours in UWP Scheduler](daymodule_images/changeworkinghours_day.png)
...
{% endhighlight %}
{% endtabs %}
![Timeslot Appearance Customization in UWP Scheduler](daymodule_images/timeslotappearance_day.png)
...
{% endhighlight %}
{% endtabs %}
![Non-Accessible Timeslots in UWP Scheduler](daymodule_images/nonaccessibleblock_day.png)
...
{% endhighlight %}
{% endtabs %}
![Time label format Customization in UWP Scheduler](daymodule_images/timelabelformat_day.png)
...
{% endhighlight %}
{% endtabs %}
![TimeLabel Appearance in UWP Scheduler](daymodule_images/timelabelappearance_day.png)
...
{% endhighlight %}
{% endtabs %}
![Selection Customization using Style in UWP Scheduler](daymodule_images/selectionstyle_day.png)
...
{% endhighlight %}
{% endtabs %}
![Selection customization using custom View in UWP Scheduler](daymodule_images/custoselectionview_day.png)
...
{% endhighlight %}
{% endtabs %}
![Adding Resources in Scheduler UWP Scheduler](daymodule_images/addresource_day.png)
...
{% endhighlight %}
{% endtabs %}
![SubResources Type in UWP Scheduler](daymodule_images/subresource_day.png)
...
{% endhighlight %}
{% endtabs %}
![Changing the Resource order in UWP Scheduler](daymodule_images/orderbydate_day.png)
...
{% endhighlight %}
{% endtabs %}
![Order by resource in UWP Scheduler](daymodule_images/orderbyresource_day.png)
...
{% endhighlight %}
{% endtabs %}
![Resource Visibility Customization in UWP Scheduler](daymodule_images/column_day.png)
