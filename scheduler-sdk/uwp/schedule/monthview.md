...
![Month View in UWP Scheduler](monthview_images/monthview.png)
...
![Restricted days in month view UWP Scheduler](monthview_images/blackoutdate.png)
...
![FirstDayOfWeek in Month UWP Scheduler](monthview_images/firstdayofweek.png)
...
![Week number of the year in UWP Scheduler](monthview_images/showweeknumber.png)
...
![Week number appearance in UWP Scheduler](monthview_images/weeknumberstyle.png)
...
![ViewHeader Appearance in UWP Scheduler](monthview_images/viewheaderstyle.png)
...
![Customize the month cell using style in UWP Scheduler](monthview_images/monthcellstyle.png)
...
![Customize the month cell using event in UWP Scheduler](monthview_images/monthcellstyle_event.png)
