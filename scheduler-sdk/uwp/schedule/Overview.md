...
description: Learn here all about the introduction of the Syncfusion UWP Scheduler (SfSchedule) control, its elements, and more.
...
The Scheduler is used to provide Outlook-like scheduling. The Schedule control allows users to create and manage appointments. It includes features such as viewing daily, all-day, and spanned appointments, complete customization using custom templates, efficient performance, and data binding to different sources.
