...
description: Learn how to set up a Next.js application and integrate the Syncfusion React Scheduler with views, data binding, and core scheduling features.
control: Scheduler
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
