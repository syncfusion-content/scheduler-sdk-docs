---
layout: post
title: Editor Template in React Scheduler | Syncfusion
description: Learn how to customize the Syncfusion React Scheduler editor window with custom fields, validations, header titles, and footer button text.
control: Scheduler
platform: ej2-react
documentation: ug
domainurl: ##DomainURL##
...
# Editor Template in React Scheduler
