...
# Getting Started with DateRangePicker Component in Blazor WASM App
...
Add the Blazor DateRangePicker component in the **~/Pages/*.razor** (for example, **Home.razor**) file.
