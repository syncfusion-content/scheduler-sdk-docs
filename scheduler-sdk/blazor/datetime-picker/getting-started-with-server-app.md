---
layout: post
title: Getting Started with Blazor DateTime Picker in Server App | Syncfusion
description: Check out and learn how to get started with the Blazor DateTime Picker component in a Blazor Server App.
platform: scheduler-sdk
component: DateTime Picker
documentation: ug
---

# Getting Started with Blazor DateTime Picker in Blazor Server App

This section briefly explains how to include the [Blazor DateTimePicker](https://www.syncfusion.com/blazor-components/blazor-datetime-picker) component in a Blazor Server App using [Visual Studio](https://visualstudio.microsoft.com/vs/), [Visual Studio Code](https://code.visualstudio.com/), and the [.NET CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/).
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The Blazor DateTime Picker component will render in your default web browser.
...
Define the minimum and maximum date and time using the [Min](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Calendars.SfDateTimePicker-1.html#Syncfusion_Blazor_Calendars_SfDateTimePicker_1_Min) and [Max](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Calendars.SfDateTimePicker-1.html#Syncfusion_Blazor_Calendars_SfDateTimePicker_1_Max) properties.
{% tabs %}
{% highlight razor tabtitle="Home.razor" %}
...
3. [Getting Started with Blazor DateTime Picker Events](https://blazor.syncfusion.com/documentation/datetime-picker/events)
4. [Getting Started with Blazor DateTime Picker Globalization](https://blazor.syncfusion.com/documentation/datetime-picker/globalization)
