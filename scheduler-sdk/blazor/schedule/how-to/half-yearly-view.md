...
The Year view of Scheduler displays all 365 days and the related appointments for a particular year. The Year view can be customized by using the following properties:
...
In the following code example, you can see how to render only the last six months of a year in Scheduler. To start with June, `FirstMonthOfYear` is set to 6 and `MonthsCount` is set to 6 to render only six months.
