...
description: Learn how to show a half-yearly view in the Syncfusion Blazor Scheduler by customizing the year view to render a specific range of consecutive months.
platform: scheduler-sdk
control: Scheduler
documentation: ug
---

# Half-Yearly View in Blazor Scheduler

The Year view of Blazor Scheduler displays all 365 days and the related appointments for a particular year. The Year view can be customized by using the following properties:
...
In the following code example, you can see how to render only the last six months of a year in Blazor Scheduler. To start with June, `FirstMonthOfYear` is set to 6 and `MonthsCount` is set to 6 to render only six months.
