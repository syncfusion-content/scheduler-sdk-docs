...
{% include code-snippet/scheduler-sdk/vue/datetime-picker/timezone-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/scheduler-sdk/vue/datetime-picker/timezone-cs1" %}