...
{% include code-snippet/scheduler-sdk/asp-net-core/calendar/daterange/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/scheduler-sdk/asp-net-core/calendar/daterange/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Daterange.cs" %}
{% include code-snippet/scheduler-sdk/asp-net-core/calendar/daterange/daterange.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
