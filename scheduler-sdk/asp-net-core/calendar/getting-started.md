---
layout: post
title: Getting Started with ASP.NET Core Calendar Control | Syncfusion
description: Checkout and learn about getting started with ASP.NET Core Calendar control of Syncfusion Essential JS 2 and more details.
...
This section briefly explains how to include the [ASP.NET Core Calendar](https://www.syncfusion.com/aspnet-core-ui-controls/calendar) control in an ASP.NET Core application using Visual Studio.
...
{% include code-snippet/scheduler-sdk/asp-net-core/calendar/getting-started/getting-started/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
![ASP.NET Core Calendar Control](images/calendar-control.png)
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-core/calendar/getting-started/daterange/tagHelper %}
{% endhighlight %}
{% endtabs %}
