---
layout: post
title: Ej1 Api Migration in ASP.NET Core Datepicker Component
description: Learn here all about Ej1 Api Migration in Syncfusion ASP.NET Core Datepicker component of Syncfusion Essential JS 2 and more.
