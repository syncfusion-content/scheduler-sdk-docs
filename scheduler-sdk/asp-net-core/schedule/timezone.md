...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-core/schedule/timezone/sametime/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Data.cs" %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-core/schedule/timezone/specific-timezone/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Data.cs" %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-core/schedule/timezone/timezone-collection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Data.cs" %}
