...
{% include code-snippet/scheduler-sdk/asp-net-core/time-picker/getting-started/getting-started/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-core/time-picker/getting-started/daterange/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/scheduler-sdk/asp-net-core/time-picker/getting-started/format/tagHelper %}
{% endhighlight %}
{% endtabs %}
