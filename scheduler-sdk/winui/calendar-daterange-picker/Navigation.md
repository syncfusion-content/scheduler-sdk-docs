...
You can easily navigate to the month, year, decade, or century views to select different date ranges in the drop-down calendar by clicking the header button. Initially, the month view is loaded in the drop-down calendar.
...
You can restrict navigation within a minimum and maximum view by using the [`MinDisplayMode`](https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Calendar.SfCalendarDateRangePicker.html#Syncfusion_UI_Xaml_Calendar_SfCalendarDateRangePicker_MinDisplayMode) and [`MaxDisplayMode`](https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.Calendar.SfCalendarDateRangePicker.html#Syncfusion_UI_Xaml_Calendar_SfCalendarDateRangePicker_MaxDisplayMode) properties. This will be useful when your date range is smaller and you do not want to show the decade and century views.
...
N> When the `MinDisplayMode` property value is **Year** and the `MinDate` value is **15/01/2021**, selecting the month of the minimum date will set the starting date value from the minimum date, i.e., from *January 15, 2021*.
