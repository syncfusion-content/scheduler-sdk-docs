---
layout: post
title: Timescale in TypeScript Scheduler | Syncfusion
description: Learn how to customize time slots in the Syncfusion TypeScript Scheduler using the timeScale property to set interval and slot count.
