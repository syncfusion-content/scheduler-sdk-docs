...
- [`addEvent`](https://ej2.syncfusion.com/documentation/api/schedule#addevent) – Creates new event(s)
- [`saveEvent`](https://ej2.syncfusion.com/documentation/api/schedule#saveevent) – Updates or creates an event
- [`deleteEvent`](https://ej2.syncfusion.com/documentation/api/schedule#deleteevent) – Removes event(s)
