...
description:  Checkout and learn about Getting started with TypeScript Daterangepicker control of Syncfusion Essential JS 2 and more details.
...
# Getting started in TypeScript Daterangepicker control
...
{% include code-snippet/scheduler-sdk/typescript/daterange-picker/getting-started-cs12/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/typescript/daterange-picker/getting-started-cs12/index.html %}
{% endhighlight %}
{% endtabs %}
          
{% previewsample "https://help.syncfusion.com/code-snippet/scheduler-sdk/typescript/daterange-picker/getting-started-cs12" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/scheduler-sdk/typescript/daterange-picker/getting-started-cs13/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/scheduler-sdk/typescript/daterange-picker/getting-started-cs13/index.html %}
{% endhighlight %}
{% endtabs %}
          
{% previewsample "https://help.syncfusion.com/code-snippet/scheduler-sdk/typescript/daterange-picker/getting-started-cs13" %}
