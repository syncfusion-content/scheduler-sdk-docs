...
<script>
import { ScheduleComponent, ViewDirective, ViewsDirective, ViewDirective, ViewsDirective, Week, View, Resize, DragAndDrop, ExcelExport } from "@syncfusion/ej2-vue-schedule";
