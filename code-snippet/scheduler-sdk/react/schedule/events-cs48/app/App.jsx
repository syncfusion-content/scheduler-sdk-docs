...
function App() {
  ...
  const eventSettings = { dataSource: generateStaticEvents(new Date(2026, 4, 1), 300, 12) }
  ...
  return (<ScheduleComponent cssClass='virtual-scrolling' width='100%' height='550px' selectedDate={new Date(2026, 4, 1)} eventSettings={
