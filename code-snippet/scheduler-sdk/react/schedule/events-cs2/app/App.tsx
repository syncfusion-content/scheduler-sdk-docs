...
import { ScheduleComponent, Day, Week, WorkWeek, Month, Agenda, Inject, Resize, DragAndDrop, type EventSettingsModel } from '@syncfusion/ej2-react-schedule';
	...
	const onDataBound = () => {
		if (initialLoad.current) {
			if (scheduleRef.current) {
				const element = scheduleRef.current.element.querySelector('.e-all-day-appointment-section') as HTMLElement;
				if (element) {
					element.click();
				}
			}
